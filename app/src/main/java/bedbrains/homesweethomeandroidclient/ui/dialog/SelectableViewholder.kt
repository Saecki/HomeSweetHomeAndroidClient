...
class SelectableViewHolder<T>(private var context: Context, private var binding: SelectableBinding) :
    ...
    fun bindView(selectable: Selectable<T>) {
        ...
        if (selectable.selected) {
            binding.root.background = ContextCompat.getDrawable(context, R.drawable.selectable_background_selected)
            binding.root.background.alpha = Res.resources.getInteger(R.integer.selectable_background_alpha)
        } else {
